...
$body = $fromsubject.'
	...
	The person that contacted you is  '.$name.'
	 ...
	 '.$message.'	
	|---------END MESSAGE----------|'; 
echo "Your article has been sent for review. If it's accepted for publication, it will become available My articles section. Go to <a href='/index.php?page=profile'>Home Page</a>"; 
								//mail($to, $subject, $body,$headers);
 } else { 
//echo "You must write a message. </br> Please go to <a href='/index.html'>Home Page</a>"; 
require_once('articlesubmit.html');
}
}
